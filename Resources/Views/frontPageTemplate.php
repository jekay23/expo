<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top" role="navigation" style="height: 6vh; min-height: 60px; background-color: #54b686">
        <div class="collapse navbar-collapse container-md align-self-center">
            ...
            <!-- TODO commit when something works <img src="/image/favicons.ico" alt="Логотип ММФ">-->
...
<main class="container" role="main" style="padding-top: 70px">
...
<footer class="footer mt-auto py-3 fixed-bottom" style="background-color: #232222">
    <div class="container">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a href="#" class="nav-link px-5 text-muted">Пользовательское соглашение</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-5 text-muted">FAQ</a></li>
        </ul>
    </div>
</footer>
